          ...
          {rows.length === 0 ? (
            <EmptyState
              ...
              action={
                <Link
                  to="/cursos"
                  className="focus-ring inline-flex h-9 items-center rounded-lg bg-brand-500 px-3.5 text-sm font-medium text-white shadow-sm transition hover:bg-brand-400"
                >
                  Ver catálogo
                </Link>
              }
