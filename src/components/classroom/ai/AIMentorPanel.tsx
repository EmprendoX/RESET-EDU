...
export function AIMentorPanel({ courseId, lessonId, course, lesson }: Props) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="shrink-0 border-b border-reset-border bg-reset-bg-1 px-3 py-2.5">
        <AIContextChips
          course={course}
          lesson={lesson}
      ...
      {sendError ? (
        <div
          className="shrink-0 border-t border-rose-500/30 bg-rose-500/10 px-3 py-2 text-xs text-rose-200"
          role="alert"
        >
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="shrink-0 rounded px-1.5 py-0.5 text-[11px] font-medium text-rose-300 hover:bg-rose-500/20"
            >
              Cerrar
            </button>
          </div>
